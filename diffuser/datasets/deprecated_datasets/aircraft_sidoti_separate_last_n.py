...
class SidotiAircraftSeparateLastN(torch.utils.data.Dataset):
    def __init__(self, 
                 folder_path, 
                 horizon,
                 past_obs_length = 10,
        ...
        self.past_obs_length = past_obs_length
    ...
    def __getitem__(self, idx):
        ...
        past_obs_start = max(0, start - self.past_obs_length)

        past_obs = torch.tensor(self.red_locs[path_ind][past_obs_start:start]).float() # use all past observations
