...
dataset = "smuggler_paper_3_helo_40"

use_wavelet = False
if use_wavelet:
    dataset_loader = 'datasets.PrisonerDatasetDetectionsWavelet'
else:
    dataset_loader = 'datasets.PrisonerDatasetDetections'
...
base = {
    ...
    'diffusion': {
        ...
        'datapath': f'/coc/data/smuggler_datasets/{dataset}/train',
        'test_datapath': f'/coc/data/smuggler_datasets/{dataset}/test',
