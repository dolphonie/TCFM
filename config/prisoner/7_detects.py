...
base = {
    ...
    'diffusion': {
        ...
        'datapath': '/home/sean/PrisonerEscape/datasets/october_datasets/7_detect/train',
        'test_datapath': '/home/sean/PrisonerEscape/datasets/october_datasets/7_detect/test',
        # 'datapath': '/data/prisoner_datasets/october_datasets/4_detect/train',
        # 'test_datapath': '/data/prisoner_datasets/october_datasets/4_detect/test',
        ...
        # 'logbase': '/data/prisoner_logs/diffuser/prisoner/4_detects',
        'logbase': '/home/sean/prisoner_logs/diffuser/prisoner/7_detects',
        'prefix': 'diffusion/',
