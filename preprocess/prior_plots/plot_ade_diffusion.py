...
ax.plot(np.arange(0, 120), averages[0], linewidth=3, label='CADENCE-Low Detect Rate', color=all_colors[0])
...
ax.plot(np.arange(0, 120), averages[2], linewidth=3, label='CADENCE-High Detect Rate', color=all_colors[1])
